...
namespace BeeCard.Application.Interfaces
{
    public interface ICardAppService
    {
        ...
        void CreatePersonalCard(Guid userId, string fullName, string address, string address2, string number, string city, string postalCode, string neighborhood, string state, string phone, string cellphone, string email, string website, string socialMedias, string bio, List<string> skills, string avatarBase64);
        void UpdatePersonalCard(Guid userId, Guid cardId, string fullName, string address, string address2, string number, string city, string postalCode, string neighborhood, string state, string phone, string cellphone, string email, string website, string socialMedias, string bio, List<string> skills, string avatarBase64, bool status);
